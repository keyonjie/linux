 ...
 * and Debug) defined in USB Type-C specification. 
 *
 * All SVID specific pin configuration values must start from TYPEC_STATE_MODAL!
 * Use of values below TYPEC_STATE_MODEL is not allowed from the alternate mode
 * drivers.
 */
enum {
