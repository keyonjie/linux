...
/* Remove mtl/lnl from names after transition to generation based FW names */
static struct {
	int gen;
	const char *name;
} fw_names[] = {
	...
	{ IVPU_HW_37XX, "intel/vpu/mtl_vpu_v0.0.bin" },
	{ IVPU_HW_40XX, "vpu_40xx.bin" },
	{ IVPU_HW_40XX, "lnl_vpu.bin" },
	{ IVPU_HW_40XX, "intel/vpu/vpu_40xx_v0.0.bin" },
	{ IVPU_HW_40XX, "intel/vpu/lnl_vpu_v0.0.bin" },
	{ IVPU_HW_50XX, "vpu_50xx.bin" },
	{ IVPU_HW_50XX, "intel/vpu/vpu_50xx_v0.0.bin" },
};
...
static int ivpu_fw_mem_init(struct ivpu_device *vdev)
{
	...
	ret = ivpu_hws_log_mem_init(vdev);
	if (ret)
